<?php
	...
	*/
	...
	$markFlowPaymentArray['transactions'][0]['amount']['details']['subtotal'] = $_POST['service_amount'];
	$markFlowPaymentArray['transactions'][0]['item_list']['items'][0]['price'] = $_POST['service_amount'];
	...
	$markFlowPaymentArray['transactions'][0]['amount']['total'] = (float)$_POST['service_amount'] + (float)$_POST['estimated_shipping'] + (float)$_POST['tax'] + (float)$_POST['insurance'] + (float)$_POST['handling_fee'] + (float)$_POST['shipping_discount'];
